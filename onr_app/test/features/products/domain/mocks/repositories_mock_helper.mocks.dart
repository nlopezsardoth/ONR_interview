...
// in onr_app/test/features/products/domain/mocks/repositories_mock_helper.dart.
...
import 'package:onr_app/features/products/domain/entities/product.dart' as _i6;
import 'package:onr_app/features/products/domain/repositories/product_repository.dart'
    as _i3;
import 'package:onr_app/features/shared/data/errors/failures.dart' as _i5;
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Product>> getProductDetail(int? id) =>
      (super.noSuchMethod(
